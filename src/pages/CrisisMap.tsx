  ...
  const crises = [
    {
      ...
      coordinates: { x: '56.6%', y: '51.6%' },
      type: 'Conflict',
      severity: 'Critical',
      affected: '21M people',
      refugees: '8M displaced',
      description: 'Ongoing conflict has created one of the largest crises in Africa with epidemics, food insecurity, lack of shelter and services',
